...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { department: @complaint.department, phone: @complaint.phone, subject: @complaint.subject, type: @complaint.type, username: @complaint.username }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { department: @complaint.department, phone: @complaint.phone, subject: @complaint.subject, type: @complaint.type, username: @complaint.username }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
